...
**Trained:** 2026-05-04T04:59:42.501091+00:00
...
coefficients| post-standardization is **0.2952** against a
hard floor of 0.05. Variance-collapse flag:
**False**.

## Calibration

Raw ECE_holdout = **0.0304** against target ≤ 0.04.
Isotonic wrap applied: **False**. Calibrated ECE = **0.0304**.

## Anchor coefficient

Point estimate: **0.9767**
95% CI (Wald): **(0.7814, 1.1720)**

## Log-loss vs market prior

- Holdout log-loss (model raw): **0.6757**
- Market-prior log-loss (anchor-only baseline): **0.6780**
- Delta (positive means model improves over market): **0.0022**
