# Moneyline v0.1 candidate — Architecture (NOT PROMOTED)

> **Status:** CANDIDATE — not in production. Production v0 lives at
> `models/moneyline/current/` and is unchanged. This artifact was trained on
> 2026-05-04 against the same pinned holdout declaration after the October
> 2024 odds re-pull added ~370 graded games to the holdout slice. Side-by-side
> comparison vs the production v0:
> `docs/audits/moneyline-v0-candidate-retrain-2026-05-04-comparison.md`.
> Verdict: **REJECTED** — train-size artefact reading not confirmed; v0 stays.

**Trained:** 2026-05-04T06:36:59.674886+00:00
**Holdout declaration:** `moneyline-v0-holdout-2026-05-03` (see `models/moneyline/holdout-declaration.json`)
...
coefficients| post-standardization is **0.2635** against a
hard floor of 0.05. Variance-collapse flag:
**False**.

## Calibration

Raw ECE_holdout = **0.0252** against target ≤ 0.04.
Isotonic wrap applied: **False**. Calibrated ECE = **0.0252**.

## Anchor coefficient

Point estimate: **1.0240**
95% CI (Wald): **(0.8426, 1.2053)**

## Log-loss vs market prior

- Holdout log-loss (model raw): **0.6722**
- Market-prior log-loss (anchor-only baseline): **0.6727**
- Delta (positive means model improves over market): **0.0005**
