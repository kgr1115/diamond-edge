...
export interface AllPicksFilterValues {
  market: MarketFilter;
...
// ---------------------------------------------------------------------------
// URL param helpers (co-located — no premature abstraction)
// ---------------------------------------------------------------------------
...
export function useAllPicksFilters(): AllPicksFilterValues {
...
interface AllPicksFiltersProps {
  totalPicks: number;
  visiblePicks: number;
}

// ---------------------------------------------------------------------------
// Sub-components: segmented button groups
// ---------------------------------------------------------------------------
...
export function AllPicksFilters({ totalPicks, visiblePicks }: AllPicksFiltersProps) {
  ...
  // Local EV state during drag — commits to URL on release (same pattern as slate-filters)
  ...
  return (
    ...
    >
      ...
      {/* Row 2: Min strength + Sort + EV */}
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <div>
          <label htmlFor="all-picks-strength" className="text-xs text-gray-500 block mb-2">
            Minimum strength
          </label>
          <select
            id="all-picks-strength"
            value={minStrength}
        ...
        <div>
          <label htmlFor="all-picks-sort" className="text-xs text-gray-500 block mb-2">
            Sort by
          </label>
          <select
            id="all-picks-sort"
        ...
        <div>
          <label htmlFor="all-picks-ev" className="text-xs text-gray-500 block mb-2">
            Min EV:{' '}
